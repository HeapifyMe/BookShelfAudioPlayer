...
public class AudiobookService extends Service implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener {
    ...
    public void onCreate() {
        ...
        String NOTIFICATION_PLAYING_TITLE = "Media Player";
        String NOTIFICATION_PLAYING_DESCRIPTION = "Media Player Runnningggg...";
    ...
    void play(int id) {
        try {
            ...
            currentBookUri = null;
            mediaPlayer.reset();
            String BOOK_DOWNLOAD_URL = "https://kamorris.com/lab/audlib/download.php?id="+id;
            mediaPlayer.setDataSource(BOOK_DOWNLOAD_URL);
...
//            AudiobookService.this.play(id);
        ...
        public void mediaPlayer(int position){
            mediaPlayer.seekTo(position);
            Log.i(TAG, String.valueOf(mediaPlayer.getDuration()));
    ...
    private void createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            CharSequence name = "deepti";
            String description = "deepti bahuguna";
